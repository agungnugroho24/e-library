	...
	box-shadow:0 1px 3px rgba(0,0,0,.5);">
                <div class="container-fluid">
                    ...
                    <div class="nav-collapse collapse">
						...
						?>
                            <li class="dropdown">
                                <a href="#" role="button" class="dropdown-toggle" data-toggle="dropdown" style="color:#fff;"> <i class="icon-user icon-large"></i><?php echo $row['no_anggota']." - ".$row['nama_siswa'];  ?> <i class="caret"></i>
