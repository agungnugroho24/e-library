	<div id="edit<?php echo $id; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-body">
			<div class="alert alert-info"><strong>Edit pengguna</strong></div>
	<form class="form-horizontal" method="post">
			...
			<div class="control-group">
				...
				<input type="text" id="inputEmail" name="firstname" value="<?php echo $row['nama_depan']; ?>" required>
				</div>
			</div>
				<div class="control-group">
				...
				<input type="text" id="inputEmail" name="lastname" value="<?php echo $row['nama_belakang']; ?>" required>
				</div>
			</div>
			<div class="control-group">
				<div class="controls">
