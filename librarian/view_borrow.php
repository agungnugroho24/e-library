...
<?php include('navbar_borrow.php'); ?>
	...
	box-shadow:0 1px 3px rgba(0,0,0,.5);"><strong style="color:#000;">Buku yang dipinjam</strong></div>
                            <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
								...
								ORDER BY peminjaman.id_peminjaman DESC
								  ")or die(mysql_error());
									...
									<td> <a rel="tooltip"  title="Return" id="<?php echo $id_detil_peminjaman; ?>" href="#delete_book<?php echo $id_detil_peminjaman; ?>" data-toggle="modal"    class="btn btn-success"><i class="icon-check icon-large"></i>Return</a>
