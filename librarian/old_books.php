	...
	box-shadow:0 1px 3px rgba(0,0,0,.5);">
						...
						<!--  -->
								    <ul class="nav nav-pills">
										...
										<li class="active"><a href="old_books.php">Buku lama</a></li>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
                                ...
                                <thead>
                                    <tr>
										...
										<th>Tanggal</th>
										<th>Status</th>
										<th class="action">hapus_&_edit </th>		
                                    </tr>
                                </thead>
                                <tbody>
								 
                                  <?php  $user_query=mysql_query("select * from buku where status = 'Lama'")or die(mysql_error());
